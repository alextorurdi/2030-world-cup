(() => {
  ...
  const renderNav = (sections) => `
    <nav class="profile-nav" aria-label="Aruba profile sections">
        ...
        <div>
          ${lineup.image ? `
            <figure class="profile-lineup-image profile-media">
              ${renderImage(lineup.image, "Aruba historical line-up graphic")}
            </figure>
          ` : ""}
              ...
              <article class="profile-player-card">
                ${player.image ? `
                  <figure class="profile-player-photo">
                    ${renderImage(
                      player.image,
                      `${player.name} — Aruba historical line-up`,
    ...
    <div class="profile-host-card">
      ...
      ${section.host.image ? `
        <figure class="profile-host-image profile-media">
          ${renderImage(section.host.image, "Aruba 2030 host graphic")}
        </figure>
      ` : ""}
    </div>
  `;
  ...
  const renderSection = (section) => `
    ...
    >
      <header class="profile-section-header">
        ...
        <div>
          <p class="profile-section-kicker">The 211 Files · Aruba</p>
    ...
    app.innerHTML = `
      ...
      <div class="profile-shell">
        ...
        <footer class="profile-footer">
          <p>
            Content structured from the supplied Aruba thread export.
    ...
    .catch((error) => {
      ...
      app.innerHTML = `
        <div class="profile-error">
          <h1>The Aruba page could not be loaded</h1>
          <p>
