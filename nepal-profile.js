(() => {
      ...
      <div class="profile-hero-inner">
        <div class="profile-hero-copy">
          ...
          <div class="profile-hero-badges">
            ...
            <span>Region: ${esc(hero.region)}</span>
          </div>
  ...
  const renderNav = (sections) => `
    <nav class="profile-nav" aria-label="Nepal profile sections">
      ${sections
        .map(
          (section) => `
  ...
  const renderSection = (section) => `
    ...
    >
      <header class="profile-section-header">
        ...
        <div>
          <p class="profile-section-kicker">The 211 Files · Nepal</p>
  ...
  const renderPage = (data) => {
    ...
    app.innerHTML = `
      ...
      <div class="profile-shell">
        ...
        <aside class="profile-source-note">
          <strong>Source numbering:</strong>
          ${esc(data.meta.numberingNote)}
        </aside>

        <footer class="profile-footer">
          <p>
            Page content is structured from the attached Nepal source document.
            Its terminology, section order, framing and substantive claims have
            been retained, with light grammar and spacing normalisation.
          </p>
        </footer>
      </div>
    `;
    ...
    .catch((error) => {
      ...
      app.innerHTML = `
        <div class="profile-error">
          <h1>The Nepal page could not be loaded</h1>
          <p>
